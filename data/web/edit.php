...
if (!isset($_SESSION['maimail_cc_role']) OR !in_array($_SESSION['maimail_cc_role'], $AuthUsers)) {
  header('Location: /');
  exit();
}
...
if (isset($_SESSION['maimail_cc_role'])) {
  ...
  if ($_SESSION['maimail_cc_role'] == "admin"  || $_SESSION['maimail_cc_role'] == "domainadmin" || $_SESSION['maimail_cc_role'] == "user") {
