...
<clientConfig version="1.1">
    <emailProvider id="<?=$maimail_hostname; ?>">
      <domain>%EMAILDOMAIN%</domain>
      <displayName>A maimail mail server</displayName>
...
<?php } ?>
      ...
      <enable visiturl="https://<?=$maimail_hostname; ?><?php if ($port != 443) echo ':'.$port; ?>/admin">
    ...
    <webMail>
      <loginPage url="https://<?=$maimail_hostname; ?><?php if ($port != 443) echo ':'.$port; ?>/SOGo/" />
    </webMail>
</clientConfig>
