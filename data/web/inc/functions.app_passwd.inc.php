  ...
  switch ($_action) {
    ...
    case 'delete':
      ...
      foreach ($ids as $id) {
        ...
        if (!hasMailboxObjectAccess($_SESSION['maimail_cc_username'], $_SESSION['maimail_cc_role'], $mailbox)) {
          $_SESSION['return'][] = array(
            'type' => 'danger',
            'log' => array(__FUNCTION__, $_action, $_data_log),
            'msg' => 'access_denied'
    ...
    case 'details':
      ...
      if (!hasMailboxObjectAccess($_SESSION['maimail_cc_username'], $_SESSION['maimail_cc_role'], $app_passwd_data['mailbox'])) {
        $app_passwd_data = array();
        return false;
      }
