...
if (isset($_SESSION['maimail_cc_role']) && ($_SESSION['maimail_cc_role'] == "admin"|| $_SESSION['maimail_cc_role'] == "domainadmin")) {
  ...
  $ch = curl_init('http://ip4.maimail.email');
  ...
  $ch = curl_init('http://ip6.maimail.email');
    ...
    <table class="table table-striped">
      ...
      foreach ($records as &$record) {
        ...
        if ($record[1] == 'TLSA') {
          ...
          if ($record[0] == $maimail_hostname && ($record[1] == "A" || $record[1] == "AAAA")) {
