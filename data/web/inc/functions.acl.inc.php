...
function acl($_action, $_scope = null, $_data = null, $_extra = null) {
  ...
  switch ($_action) {
      ...
      switch ($_scope) {
        case 'user':
          ...
          if ($_SESSION['maimail_cc_role'] == 'domainadmin') {
            ...
            $self_da_acl = acl('get', 'domainadmin', $_SESSION['maimail_cc_username']);
        ...
        case 'domainadmin':
          ...
          if ($_SESSION['maimail_cc_role'] == 'domainadmin' && $_SESSION['maimail_cc_username'] != $_data) {
            return false;
          }
    ...
    case 'to_session':
      ...
      unset($_SESSION['acl']);
      $username = strtolower(trim($_SESSION['maimail_cc_username']));
