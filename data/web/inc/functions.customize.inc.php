      ...
      switch ($_item) {
        ...
        case 'ui_texts':
          try {
            ...
            $data['title_name'] = ($title_name = $redis->get('TITLE_NAME')) ? $title_name : "$maimail_hostname - mail UI";
            $data['main_name'] = ($main_name = $redis->get('MAIN_NAME')) ? $main_name : "$maimail_hostname - mail UI";
